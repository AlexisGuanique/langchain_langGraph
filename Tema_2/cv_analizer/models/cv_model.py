...
# Definimos nuestro modelo de datos que esperamos que devuelva la IA.
# Indicamos con Field el tipo de dato que esperamos que devuelva la IA.
...
class AnalisisCV(BaseModel):
    ...
    # con las palabras clave ge y le indicamos que el porcentaje de ajuste debe ser un numero entre 0 y 100.
